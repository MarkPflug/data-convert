...
using System.Data.Common;
    ...
    static class DataReaderExtensions
    {
        ...
        public static long WriteParquet(this DbDataReader reader, string filename, int rowGroupSize = 0x10000)
        {
            using Stream stream = File.Create(filename);
            return WriteParquet(reader, stream, rowGroupSize);
        }
        ...
        /// <param name="rowGroupSize">The size of the parquet row groups to write.</param>
        public static long WriteParquet(this DbDataReader reader, Stream stream, int rowGroupSize = 0x10000)
        {
